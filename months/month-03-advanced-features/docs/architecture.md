...
This project follows a strict **Layered Architecture**, designed to separate business logic from infrastructure details (Database, HTTP Framework, Real-time Communication).
